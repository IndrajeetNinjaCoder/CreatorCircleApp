...
//    val password: String? = null,
//    val mobileNumber: String? = null,
//    val platformFollowers: String? = null,
//    val username: String? = null,
...
//                }
//
//                // Call API with direct string/int values (no RequestBody conversion needed)
//                val response = apiService.updateUser(
//                    token = "Bearer $token",
//                    fullName = updateRequest.fullName,
//                    password = updateRequest.password,
//                    mobileNumber = updateRequest.mobileNumber,
//                    platformFollowers = updateRequest.platformFollowers,
//                    username = updateRequest.username,
//                    socialMediaLinks = updateRequest.socialMediaLinks,
//                    onboardingStatus = updateRequest.onboardingStatus,
//                    categories = updateRequest.categories,
//                    bio = updateRequest.bio,
//                    age = updateRequest.age // Direct integer value, no conversion
//                )
//
//                if (response.isSuccessful) {
//                    response.body()?.let { updateResponse ->
