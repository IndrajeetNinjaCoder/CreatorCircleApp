...
data class SocialMediaResponse(
    ...
    val growthSuggestions: List<ConnectionUser>? = null, // Made nullable
...
// Extension functions for convenience - WITH NULL SAFETY
...
// Fixed: Handle null growthSuggestions
fun SocialMediaResponse.getTotalGrowthSuggestions(): Int = growthSuggestions?.size ?: 0
