...
@Composable
fun UserProfileScreen(navController: NavController, userId: Int, userType: String = "User") {
    ...
    val influencerProfile = otherUserProfiles[userId]
    val isLoading = otherUserLoading.contains(userId)
    val error = otherUserError[userId]
    ...
    val influencerPosts = userPostsMap[userId] ?: emptyList()
    val influencerPostsLoading = userPostsLoadingSet.contains(userId)
    val influencerPostsError = userPostsErrorMap[userId]
            ...
            when {
                ...
                influencerProfile != null -> {
                    UserProfileContent(
                        ...
                        userType = userType, // Pass userType to content
